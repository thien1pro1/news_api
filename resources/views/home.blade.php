...
Trang quản trị
  ...
  <!--     Fonts and icons     -->
  <link href="{{asset('dashboard/css/css1.css')}}" rel="stylesheet" />
  <link href="{{asset('dashboard/css/css2.css')}}" rel="stylesheet">
  <!-- CSS Files -->
...
<body class="">
  ...
  <script src="{{asset('dashboard/js/paper-dashboard.min.js?v=2.0.1')}}" type="text/javascript"></script><!-- Paper Dashboard DEMO methods, don't include it in your project! -->
