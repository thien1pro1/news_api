...
<style>
    .custom-select {
        ...
        background: #fff url(data:image/svg+xml;charset=utf8,%3Csvg xmlns= 'http://www.w3.org/2000/svg' viewBox= '0 0 4 5' %3E%3Cpath fill= '%23343a40' d= 'M2 0L0 2h4zm0 5L0 3h4z' /%3E%3C/svg%3E) no-repeat right 0.75 rem center;
...
-->
            ...
            <select name="categogy_id" class="form-control">
                ...
                <option {{$cate->id==$edit->category_id ? 'selected' : ''}}
                    value="{{$cate->id}}">{{$cate->categogyName}}
                </option>
                @endforeach
